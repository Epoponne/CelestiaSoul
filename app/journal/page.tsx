...
export default function Journal() {
  ...
  return (
    <main style={{background:'#06050E',minHeight:'100vh',color:'#E8E0FF',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'20px',textAlign:'center'}}>
      <h1 style={{fontStyle:'italic',fontSize:'48px',color:'#C8A8FF',marginBottom:'16px'}}>Soul Journal</h1>
      <p style={{fontSize:'14px',letterSpacing:'3px',color:'rgba(200,168,255,0.6)',marginBottom:'40px'}}>Your sacred moon journal</p>
