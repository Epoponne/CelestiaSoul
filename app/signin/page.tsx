      ...
      <div style={{width:'100%',maxWidth:'420px'}}>
        ...
        <div style={{background:'rgba(255,255,255,0.025)',border:'1px solid rgba(200,168,255,0.15)',borderRadius:'20px',padding:'32px'}}>
          <input
            ...
            style={{width:'100%',background:'rgba(138,90,255,0.07)',border:'1px solid rgba(200,168,255,0.15)',borderRadius:'10px',padding:'12px 16px',color:'#E8E0FF',fontSize:'14px',outline:'none',marginBottom:'16px',display:'block'}}
          />
          <input
            type="password"
            ...
            style={{width:'100%',background:'rgba(138,90,255,0.07)',border:'1px solid rgba(200,168,255,0.15)',borderRadius:'10px',padding:'12px 16px',color:'#E8E0FF',fontSize:'14px',outline:'none',marginBottom:'24px',display:'block'}}
          />
          {message && (
          ...
          >
            {loading ? '✦ Opening Portal...' : isSignUp ? 'Begin My Journey' : 'Enter My Sanctuary'}
          </button>
          ...
          {!isSignUp && (
            <p
              ...
              style={{textAlign:'center',fontSize:'12px',color:'rgba(200,168,255,0.35)',cursor:'pointer',letterSpacing:'1px',fontStyle:'italic'}}
            >
