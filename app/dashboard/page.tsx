...
export default function Dashboard() {
  ...
  return (
    <main style={{background:'#06050E',minHeight:'100vh',color:'#E8E0FF',fontFamily:'Georgia,serif',position:'relative',overflow:'hidden'}}>
      ...
      <div style={{position:'fixed',inset:0,pointerEvents:'none',zIndex:0}} id="stars"/>
      ...
      <div style={{position:'relative',zIndex:1,maxWidth:'680px',margin:'0 auto',padding:'0 18px 60px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px',marginBottom:'22px'}}>
          {[
            ...
            <div key={title} onClick={() => router.push(route)} style={{background:'rgba(255,255,255,0.028)',border:'1px solid rgba(200,168,255,0.1)',borderRadius:'16px',padding:'20px 16px',cursor:'pointer',transition:'all 0.3s'}}>
