    ...
    <main style={{background:'#06050E',minHeight:'100vh',color:'#E8E0FF',fontFamily:'Georgia,serif'}}>
      <div style={{maxWidth:'680px',margin:'0 auto',padding:'0 18px 60px'}}>
        ...
        <div style={{textAlign:'center',marginBottom:'40px'}}>
          <p style={{fontFamily:'sans-serif',fontSize:'10px',letterSpacing:'8px',color:'rgba(200,168,255,0.4)',marginBottom:'8px'}}>✦ SACRED MEMBERSHIP ✦</p>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'16px',marginBottom:'32px'}}>
          ...
          <div style={{background:'rgba(255,255,255,0.025)',border:'1px solid rgba(200,168,255,0.15)',borderRadius:'20px',padding:'28px 20px'}}>
            ...
            <h2 style={{fontStyle:'italic',fontSize:'28px',fontWeight:300,letterSpacing:'3px',color:'#E8E0FF',marginBottom:'4px'}}>Seeker</h2>
            ...
            <div style={{borderTop:'1px solid rgba(200,168,255,0.08)',paddingTop:'16px'}}>
              {[
                ...
                '✗ All 6 breath techniques',
                '✗ All 7 frequencies',
                '✗ Meditation music library',
              ].map((item,i)=>(
                <p key={i} style={{fontFamily:'sans-serif',fontSize:'12px',color:item.startsWith('✗')?'rgba(200,168,255,0.25)':'rgba(200,168,255,0.6)',marginBottom:'8px',letterSpacing:'1px'}}>{item}</p>
              ))}
            </div>
          ...
          <div style={{background:'linear-gradient(135deg,rgba(138,90,255,0.15),rgba(40,20,100,0.25))',border:'1px solid rgba(200,168,255,0.35)',borderRadius:'20px',padding:'28px 20px',position:'relative'}}>
            ...
            <h2 style={{fontStyle:'italic',fontSize:'28px',fontWeight:300,letterSpacing:'3px',color:'#E8E0FF',marginBottom:'4px'}}>Sacred</h2>
            ...
            <p style={{fontFamily:'sans-serif',fontSize:'11px',color:'rgba(255,214,160,0.5)',marginBottom:'20px',letterSpacing:'1px'}}>3-day free trial</p>
            <div style={{borderTop:'1px solid rgba(200,168,255,0.08)',paddingTop:'16px'}}>
              {[
                ...
                <p key={i} style={{fontFamily:'sans-serif',fontSize:'12px',color:'rgba(200,168,255,0.7)',marginBottom:'8px',letterSpacing:'1px'}}>{item}</p>
              ))}
            </div>
            <button
              onClick={handleCheckout}
              disabled={loading}
              style={{width:'100%',marginTop:'16px',padding:'14px',background:'linear-gradient(135deg,rgba(138,90,255,0.5),rgba(100,60,200,0.4))',border:'1px solid rgba(200,168,255,0.5)',borderRadius:'12px',fontStyle:'italic',fontSize:'16px',letterSpacing:'4px',color:'#E8E0FF',cursor:'pointer'}}
            >
        ...
        <div style={{textAlign:'center',marginBottom:'32px'}}>
          <p style={{fontFamily:'sans-serif',fontSize:'11px',color:'rgba(200,168,255,0.35)',letterSpacing:'2px',lineHeight:1.8}}>
            Cancel anytime · Secure payment by Stripe · No hidden fees
          </p>
        </div>

        <div style={{background:'rgba(255,255,255,0.02)',border:'1px solid rgba(200,168,255,0.08)',borderRadius:'16px',padding:'24px',textAlign:'center'}}>
          <p style={{fontStyle:'italic',fontSize:'11px',letterSpacing:'4px',color:'rgba(200,168,255,0.35)',marginBottom:'10px'}}>✦ YOUR COSMIC GUARANTEE ✦</p>
          <p style={{fontStyle:'italic',fontSize:'14px',color:'rgba(220,210,255,0.6)',lineHeight:1.9,margin:0}}>If CelestiaSOUL doesn't transform your spiritual practice within 3 days, your trial is completely free. No questions asked.</p>
        </div>
